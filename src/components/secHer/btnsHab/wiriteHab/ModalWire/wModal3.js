        ...
        <DivInfo id="modaDev1" className="mod">
            ...
            <div className="contain">
                <div className="inform">
                    ...
                    <div className="texto">
                        <h2>Escrita Persuasivas</h2>
                        <p> O copywriting é uma alquimia textual, uma sinfonia de palavras meticulosamente escolhidas para criar impacto, despertando emoções e conduzindo Ações com Palavras Poderosas.</p>
                    </div>
                </div>
                <div className="formu">
                    <div className="areaTex">
                        ...
                        <label>
                            <textarea
                            placeholder="com relação ao desenvolvimento de textos persuasivos, como posso lhe ajudar...?"
                            className="campoTexto"
                            spellCheck="false" 
                            onChange={(e)=>{setOpinion(`tratando-se de escrita persuasiva:\n ${e.target.value}`)}}
                            rows={4}
                            cols={50}                     
                            />
                        </label>
