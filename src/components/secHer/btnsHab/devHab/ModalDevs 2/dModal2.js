...
import post01 from "../../../../../../public/assets/UT/modaPost/sitepos.jpg"
import xizinho from "../../../../../../public/assets/UT/xizinho.svg"
import {useState } from "react";

const ModalDev2 = ({setSair})=>{
        ...
        <DivInfo id="modaDev1" className="mod">
            ...
            <div className="contain">
                <div className="inform">
                    ...
                    <div className="texto">
                        <h2>Web-sites</h2>
                        <p>Web-sites, são conjutos interconectados de  web-pages.Permitem uma conecção mais interativa com os usuários, do que uma simples pagina, proporcionando uma maneira mais eficiênte de comunicação, interação e apresentação de idéias.</p>
                    </div>
                </div>
                <div className="formu">
                    <div className="areaTex">
                        ...
                        <label>
                            <textarea
                            placeholder="com relação ao desenvolvimento de web-sites, como posso lhe ajudar...?"
