        ...
        <DivInfo id="modaDev1" className="mod">
            ...
            <div className="contain">
                <div className="inform">
                    ...
                    <div className="texto">
                        <h2>Web-Page</h2>
                        <p>São elementos fundamentais no cenário digital contemporâneo,  desempenham um papel crucial na disseminação de informações online e na conecção entre diferentes canais de conteúdo. Web-pages são indispensável a indivíduos, empresas e organizações que buscam prosperar no cenário digital.</p>
                    </div>
                </div>
                <div className="formu">
                    <div className="areaTex">
                        ...
                        <label>
                            <textarea
                            placeholder="com relação ao desenvolvimento de web-pages, como posso lhe ajudar...?"
